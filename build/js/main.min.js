...
var _toggle = require("./modules/nav/toggle");
var _promoSlider = require("./modules/promo/promo-slider");
var _filters = require("./modules/filters/filters");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _toggle.toggleNav)();
  (0, _promoSlider.createPromoSlider)();
  (0, _filters.initRangeSliders)();
...
},{"./modules/filters/filters":3,"./modules/form-validate/form":5,"./modules/leaflet/leaflet":11,"./modules/modals/init-modals":12,"./modules/nav/toggle":14,"./modules/promo/promo-slider":15,"./utils/ios-vh-fix":18,"./vendor/select/custom-select":23}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initRangeSliders = void 0;
...
var initRangeSliders = function initRangeSliders() {
  ...
  var _loop = function _loop() {
    if (rangeSliders[i].getAttribute('data-range-slider') === 'price') {
      var slider = _nouislider.default.create(rangeSliders[i], {
        start: [0, 900],
        connect: true,
        range: {
          min: 0,
        ...
        format: {
          ...
          from: function from(value) {
            return Number(value.replace(/\D/g, '').replace(/\s/g, ''));
          }
        }
      });
      ...
      minInput.addEventListener('blur', function () {
        var _slider$get = slider.get(),
          _slider$get2 = _slicedToArray(_slider$get, 1),
          min = _slider$get2[0]; // Получение текущих значений ползунков
      ...
      maxInput.addEventListener('blur', function () {
        var _slider$get3 = slider.get(),
          _slider$get4 = _slicedToArray(_slider$get3, 2),
          max = _slider$get4[1]; // Получение текущих значений ползунков
        maxInput.value = Math.round(max).toLocaleString('ru'); // Установка текущего значения поля ввода
      });

      minInput.addEventListener('input', function () {
        var minVal = parseInt(minInput.value.replace(/\D/g, ''), 10);
        var maxVal = parseInt(maxInput.value.replace(/\D/g, ''), 10);
        if (isNaN(minVal)) {
          0, _readOnlyError("minVal");
        }
...
exports.initRangeSliders = initRangeSliders;

},{"nouislider":1}],4:[function(require,module,exports){
"use strict";
...
var initLeaflet = function initLeaflet() {
  var map = _leaflet.default.map('map', {
    ...
    dragging: false
  }).setView([59.970371692077016, 30.307493299822706], 14);
  ...
  _leaflet.default.marker([59.970371692077016, 30.307493299822706], {
    icon: myIcon
  }).addTo(map);
};
exports.initLeaflet = initLeaflet;

},{"../../vendor/leaflet":21}],12:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":16,"../../utils/scroll-lock":20}],14:[function(require,module,exports){
"use strict";
...
exports.createPromoSlider = createPromoSlider;

},{"../../utils/is-mobile":19,"../../vendor/swiper":25}],16:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":22,"./utils":24}],24:[function(require,module,exports){
"use strict";
