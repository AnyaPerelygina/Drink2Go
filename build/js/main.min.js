...
var initRangeSliders = function initRangeSliders() {
  ...
  var _loop = function _loop(i) {
    if (rangeSliders[i].getAttribute('data-range-slider') === 'price') {
      _nouislider.default.create(rangeSliders[i], {
        start: [0, 700],
        connect: true,
        range: {
          min: 0,
      ...
      var handleUpper = rangeSliders[i].querySelector('.noUi-handle-upper');
      var tooltip = handleUpper.querySelector('.noUi-tooltip');
      rangeSliders[i].noUiSlider.on('update', function () {
        var value = rangeSliders[i].noUiSlider.getPositions();
        if (value[1] > 90) {
